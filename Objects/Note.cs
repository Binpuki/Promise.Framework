...
public partial class Note : Control
{
    ...
    /// </summary>
    [ExportGroup("Status"), Export] public bool Missed;
    ...
    [ExportGroup("Debug"), Export] private float _tailOffset;
    ...
    public override void _Process(double delta)
    {
        ...
        float songPos = (float)(Conductor.Time * 1000d);
    ...
    public void UnsetHold()
    {
        ...
        _tailOffset = (float)(Data.MsTime - Conductor.Time * 1000d);
    }
}